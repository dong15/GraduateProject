	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_LABPROJECT071M, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LABPROJECT071M));
	wcex.hCursor = LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCE(IDC_LABPROJECT071M);
...
{
	ghInstance = hInstance; // 인스턴스 핸들을 전역 변수에 저장합니다.
