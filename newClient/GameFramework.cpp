...
CGameFramework::CGameFramework()
{
	...
	m_pScene = NULL;
	m_pPlayer = NULL;
	_tcscpy_s(m_pszBuffer, _T("Predators"));
...
void CGameFramework::ProcessInput()
{
	...
	if (!bProcessedByScene)
	{
		...
		if ((dwDirection != 0) || (cxDelta != 0.0f) || (cyDelta != 0.0f))
		{
			...
			if (dwDirection) m_pPlayer->Move(dwDirection, 1000.0f * m_GameTimer.GetTimeElapsed(), false);
		}
...
void CGameFramework::FrameAdvance()
{
	...
	float fClearColor[4] = { 0.66f, 1.0f, 1.0f, 1.0f };
